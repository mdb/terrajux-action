...
RUN \
  curl \
    --location \
    --remote-name \
    https://github.com/rhenning/terrajux/releases/download/v0.3.1/terrajux_0.3.1_linux_amd64.tar.gz && \
  tar zxvf terrajux_0.3.1_linux_amd64.tar.gz && \
  cp terrajux_0.3.1_linux_amd64/terrajux /usr/bin && \
  rm -rf terrajux_0.3.1_linux_amd64 && \
